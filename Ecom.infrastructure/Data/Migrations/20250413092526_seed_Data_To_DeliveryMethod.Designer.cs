...
namespace Ecom.infrastructure.Data.Migrations
{
    ...
    [Migration("20250413092526_seed_Data_To_DeliveryMethod")]
    partial class seed_Data_To_DeliveryMethod
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ecom.Core.Entities.Orders.DeliveryMethod", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Description = "The best in products shipping",
                            Name = "Aramex",
                            Price = 20m,
                            ShippingTime = "within week"
                        },
                        new
                        {
                            Id = 2,
                            Description = "Make your products safe",
                            Name = "DHL",
                            Price = 10m,
                            ShippingTime = "within Two dayes"
                        });
                });
            ...
            modelBuilder.Entity("Ecom.Core.Entities.Orders.Orders", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ecom.Core.Entities.Orders.OrderItem", b =>
                {
                    b.HasOne("Ecom.Core.Entities.Orders.Orders", null)
                        .WithMany("orderItems")
            ...
            modelBuilder.Entity("Ecom.Core.Entities.Orders.Orders", b =>
                {
                    ...
                    b.OwnsOne("Ecom.Core.Entities.Orders.ShippingAddress", "shippingAddress", b1 =>
                        {
